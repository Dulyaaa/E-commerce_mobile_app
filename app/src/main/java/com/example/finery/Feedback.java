...
public class Feedback extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                try {
                    if (TextUtils.isEmpty(editTextName.getText().toString()))
                        ...
                        dbRef.child("feed5").setValue(fed);
        ...
        buttonSH.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                readref = FirebaseDatabase.getInstance().getReference().child("Feed").child("feed5");
        ...
        buttonUP.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                upRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (dataSnapshot.hasChild("feed5")){
                            try {
                                fed.setName(editTextName.getText().toString().trim());
                                fed.setContact(Integer.parseInt(editTextContact.getText().toString().trim()));
                                fed.setProname(editTextPname.getText().toString().trim());
                                ...
                                dbRef = FirebaseDatabase.getInstance().getReference().child("Feed").child("feed5");
                                dbRef.setValue(fed);
                                clearControls();
